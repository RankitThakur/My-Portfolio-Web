...
export default function NotFound({ }: Props) {
  return (
    <>
      <CustomHead title="Rankit Thakur | Not Found" description="Page not found" />
      ...
      <HomeLayout>
        <div className="flex flex-col items-center justify-center w-full h-full mt-32">
          ...
          <Link href="/" passHref>
            <a className="px-5 py-2 mt-8 font-bold border-2 rounded-md text-neonGreen border-neonGreen">
              Back to Home
            </a>
          </Link>
        </div>
